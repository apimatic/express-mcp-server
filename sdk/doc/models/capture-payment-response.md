...
| `outcome` | `string` | Required | Outcome of the request; one of the following: captured \| partially captured |
...
| `actions` | [`CapturePaymentResponseActions \| undefined`](../../doc/models/capture-payment-response-actions.md) | Optional | - |
